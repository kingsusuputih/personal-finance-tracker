    ...
    <aside className="fixed inset-y-0 left-0 z-40 hidden w-64 flex-col border-r border-rule bg-paper-2 lg:flex">
      ...
      <div className="border-t border-rule p-3">
        <a
          ...
          className="mb-2 flex items-center justify-center gap-1.5 rounded-btn px-3 py-1.5 text-xs font-medium text-ink-3 transition-colors hover:bg-paper-3 hover:text-accent">
          <svg
            viewBox="0 0 24 24"
