...
const variants = {
  ...
  ghost: 'text-ink-2 hover:bg-paper-2 active:translate-y-px disabled:text-ink-3',
  danger: 'bg-danger text-white hover:opacity-90 active:translate-y-px disabled:opacity-50',
}
