      ...
      <main className="min-w-0 flex-1 md:pl-64">
        <div className="mx-auto max-w-5xl px-4 py-6 md:px-8 md:py-10">
          <header className="mb-8">
            ...
            <h1 className="text-[clamp(1.75rem,4vw,2.5rem)] font-bold">Dashboard</h1>
          </header>
          ...
          {provisioning ? (
            ...
            <>
              <section className="mb-8 grid gap-4 sm:grid-cols-2">
                <Card className="p-5">
                  <p className="kbd text-[10px] text-ink-3">Monthly income</p>
                  <p className="amount mt-2 text-2xl font-semibold text-ink">
                    {formatIDR(calc.monthlyIncome)}
                  </p>
                  {calc.monthlyIncome === 0 && (
                    <p className="mt-1 text-xs text-ink-3">Add your income in the Ledger.</p>
                  )}
                </Card>
                <Card className="p-5">
                  <p className="kbd text-[10px] text-ink-3">Total monthly expenses</p>
                  <p className="amount mt-2 text-2xl font-semibold text-ink">
              ...
              <section className="mb-8">
                <h2 className="mb-3 text-base font-semibold text-ink">50 / 30 / 20 allocation</h2>
              ...
              <section className="mb-8">
                <h2 className="mb-3 text-base font-semibold text-ink">Fund targets</h2>
                <div className="grid gap-4 sm:grid-cols-2">
                  <FundTargetCard
