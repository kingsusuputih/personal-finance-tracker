      ...
      <main className="min-w-0 flex-1 md:pl-64">
        <div className="mx-auto max-w-5xl px-4 py-6 md:px-8 md:py-10">
          <header className="mb-8">
            <p className="kbd mb-1 text-[11px] text-ink-3">Ledger</p>
            <h1 className="text-[clamp(1.75rem,4vw,2.5rem)] font-bold">Record &amp; review</h1>
            <p className="mt-2 text-sm text-ink-3">
              Enter your monthly income and daily expenses. Every entry is written straight to your
              Google Sheet.
            </p>
          </header>
