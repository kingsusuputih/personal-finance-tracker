...
assert.equal(getCycleKeyForDate("2026-08-24", 25), "2026-08");
assert.equal(getCycleKeyForDate("2026-08-25", 25), "2026-09");
assert.equal(getCycleKeyForDate("2026-09-24", 25), "2026-09");
assert.equal(getCycleKeyForDate("2026-09-25", 25), "2026-10");

const midPeriod = new Date("2026-09-10T05:00:00Z");
const infoMid = getCycleInfo(midPeriod, "Asia/Jakarta", 25);
assert.equal(infoMid.cycleKey, "2026-09");
...
assert.equal(infoPost.cycleKey, "2026-10");
...
assert.equal(infoDec.cycleKey, "2027-01");
